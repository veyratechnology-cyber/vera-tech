...
INSERT INTO services (
  ...
  '[{"question": "How long does digital transformation take?", "answer": "Typically 6-18 months depending on scope. We break it into phases so you see value quickly while building toward the complete vision."}, {"question": "Will this disrupt our current operations?", "answer": "We design transformation programs to minimize disruption. Changes are phased, thoroughly tested, and implemented with full support to ensure business continuity."}, {"question": "What if our team resists change?", "answer": "Change management is built into our approach. We involve your team early, provide comprehensive training, and ensure everyone understands the benefits."}, {"question": "Do we need to replace all our systems?", "answer": "Not necessarily. We assess what can be improved, integrated, or replaced. Often, strategic upgrades and integrations deliver better value than complete replacement."}]'
);
...
INSERT INTO services (
  ...
  '[{"question": "Which cloud provider should we choose?", "answer": "It depends on your specific needs. AWS has the broadest services, Azure integrates well with Microsoft tools, and Google Cloud excels at data analytics. We help you choose based on your requirements and budget."}, {"question": "How long does cloud migration take?", "answer": "Simple migrations can take 2-4 weeks. Complex enterprise migrations may take 3-6 months. We break it into phases to minimize risk and deliver value incrementally."}, {"question": "Will our data be secure in the cloud?", "answer": "Yes. Major cloud providers offer enterprise-grade security often superior to on-premise solutions. We implement encryption, access controls, and monitoring to ensure your data is protected."}, {"question": "What about our existing software?", "answer": "Most modern applications work well in the cloud. For legacy systems, we assess compatibility and plan appropriate migration strategies or modernization approaches."}]'
);
...
INSERT INTO services (
  ...
  '[{"question": "Are we too small to be a cyber attack target?", "answer": "No. Small businesses are increasingly targeted because they often have weaker defenses. 43% of cyber attacks target small businesses."}, {"question": "How much should we spend on cybersecurity?", "answer": "Typically 5-15% of IT budget depending on your industry and risk profile. We help you prioritize investments for maximum protection at your budget level."}, {"question": "What happens if we get breached?", "answer": "With our incident response plan, you will have clear steps to contain, investigate, and recover from incidents quickly, minimizing damage and downtime."}, {"question": "Do we need a full-time security team?", "answer": "Not necessarily. We can provide ongoing monitoring and management, supplementing your team or serving as your complete security function."}]'
);
...
INSERT INTO services (
  ...
  '[{"question": "Do we need big data to use AI?", "answer": "Not always. Many practical AI applications work with modest data. We assess your data and recommend approaches that fit what you have."}, {"question": "How accurate are AI predictions?", "answer": "It varies by use case. We set realistic expectations, measure accuracy, and continuously improve models. Most business applications achieve 80-95% accuracy."}, {"question": "Will AI replace our employees?", "answer": "Our focus is augmentation, not replacement. AI handles repetitive tasks so your team can focus on higher-value work requiring human judgment and creativity."}, {"question": "How long before we see ROI?", "answer": "Proof of concepts show value in 4-8 weeks. Full production implementations typically show measurable ROI within 6-12 months."}]'
);
...
INSERT INTO services (
  ...
  '[{"question": "How long does custom development take?", "answer": "Simple applications: 2-3 months. Medium complexity: 4-6 months. Enterprise systems: 6-12+ months. We break projects into phases so you see progress and value continuously."}, {"question": "How much does custom software cost?", "answer": "It varies widely based on complexity. Simple tools start at $15K-$30K. Enterprise applications can be $100K+. We provide detailed estimates after understanding your needs."}, {"question": "What if we need changes after launch?", "answer": "We offer ongoing support and enhancement packages. Many clients keep us on retainer for continuous improvements based on user feedback."}, {"question": "Will we own the source code?", "answer": "Yes. You own all code and intellectual property we create for you. You are never locked into working with us."}]'
);
...
INSERT INTO services (
  ...
  '[{"question": "Which processes should we automate first?", "answer": "We help you prioritize based on frequency, time consumed, error rate, and business impact. Usually start with high-volume, rule-based processes."}, {"question": "Will automation work with our existing systems?", "answer": "Almost always yes. Modern automation tools integrate with most systems through APIs, webhooks, or even screen automation for legacy applications."}, {"question": "What if the process changes?", "answer": "Automation workflows can be updated easily. We design flexible solutions and can provide ongoing support for changes as your business evolves."}, {"question": "How quickly can we see results?", "answer": "Simple automations can be implemented in days. Complex workflows may take 2-4 weeks. ROI is typically immediate once automation is live."}]'
);
...
INSERT INTO services (
  ...
  '[{"question": "What if our data is messy?", "answer": "Most data is messy. Part of our work is data cleaning and standardization. We build pipelines that continuously clean and validate data."}, {"question": "Which BI tool should we use?", "answer": "Depends on your ecosystem. Power BI works well with Microsoft. Tableau excels at visualization. Looker is great for technical teams. We help you choose."}, {"question": "Can our team build reports themselves?", "answer": "Yes. We set up self-service analytics so non-technical users can create reports without coding. We also provide training and templates."}, {"question": "How long until we see insights?", "answer": "Quick wins in 2-4 weeks with initial dashboards. Comprehensive analytics platform takes 2-3 months. We prioritize high-impact reports first."}]'
);
...
INSERT INTO services (
  ...
  '[{"question": "When should we engage a technology consultant?", "answer": "During major technology decisions, rapid growth, M&A activity, digital transformation, or when your internal team needs specialized expertise."}, {"question": "How is consulting different from other services?", "answer": "Consulting is advisory—we help you make decisions and plan. Other services are implementation—we build and deploy solutions. Often they work together."}, {"question": "What if we disagree with recommendations?", "answer": "We present options with trade-offs, not mandates. You make the final decisions. Our job is to ensure you have the information to choose wisely."}, {"question": "Can you supplement our internal team?", "answer": "Yes. Many clients use us as an extension of their team for specialized expertise, strategic planning, or during peak periods."}]'
);
...
INSERT INTO industry_pages (
  id, name, slug, industry, description, published, display_order,
  created_at, updated_at,
  challenges, solutions, relevant_services, faq
) VALUES (
  'ind_real_estate',
  'Real Estate',
  'real-estate',
  ...
  '[{"question": "How can technology improve tenant satisfaction?", "answer": "Tenant portals allow self-service maintenance requests, online payments, and real-time communication, leading to faster response times and better experiences."}, {"question": "Can you integrate with our existing property management system?", "answer": "Yes. We work with major platforms like Yardi, AppFolio, and Buildium, as well as custom systems, to create integrated workflows."}, {"question": "What ROI can we expect?", "answer": "Typical outcomes include 30-40% reduction in administrative time, faster lease cycles, improved tenant retention, and better property performance visibility."}]'
);
...
INSERT INTO industry_pages (
  ...
  '[{"question": "Will technology work in harsh field conditions?", "answer": "Yes. We recommend rugged devices and offline-capable apps that sync when connectivity is available, ensuring reliability on job sites."}, {"question": "How do we get field workers to adopt new technology?", "answer": "We focus on simple, intuitive tools that make their jobs easier. Training and change management are built into implementation."}, {"question": "Can we track project costs in real-time?", "answer": "Absolutely. Modern construction management systems provide real-time cost tracking, helping you catch budget issues before they become problems."}]'
);
...
INSERT INTO industry_pages (
  ...
  '[{"question": "How can AI improve logistics operations?", "answer": "AI can optimize routes, predict delivery times, forecast demand, and identify maintenance needs before vehicles break down."}, {"question": "Will customers get real-time tracking?", "answer": "Yes. We implement tracking portals and automated notifications so customers always know where their shipments are."}, {"question": "Can technology reduce fuel costs?", "answer": "Absolutely. Route optimization can reduce fuel consumption by 10-20%, and predictive maintenance prevents costly breakdowns."}]'
);
...
INSERT INTO industry_pages (
  ...
  '[{"question": "How can technology improve guest satisfaction?", "answer": "Digital services, personalized communications, and fast response times create memorable experiences that drive positive reviews and repeat bookings."}, {"question": "Can AI help with pricing?", "answer": "Yes. AI analyzes demand patterns, competitor pricing, and events to recommend optimal rates that maximize revenue and occupancy."}, {"question": "What about online reputation management?", "answer": "We implement systems that monitor reviews, automate responses, and track sentiment to help you maintain a strong online presence."}]'
);
...
INSERT INTO industry_pages (
  ...
  '[{"question": "How can we improve billable utilization?", "answer": "Automated time tracking, reduced administrative tasks, and clear project visibility help teams focus more time on billable work."}, {"question": "Is our client data secure?", "answer": "Yes. We implement enterprise-grade security including encryption, access controls, and compliance with industry standards."}, {"question": "Can we customize workflows to our practice?", "answer": "Absolutely. Every firm has unique processes. We tailor solutions to match how you actually work."}]'
);
...
INSERT INTO industry_pages (
  ...
  '[{"question": "When should we hire a full-time CTO?", "answer": "Typically when you reach 50-100 employees or your technology complexity demands dedicated leadership. Until then, fractional CTO services often provide better value."}, {"question": "How do we build scalable systems from the start?", "answer": "We help you design architecture that can grow with you, avoiding the need for expensive rebuilds as you scale."}, {"question": "What if our current systems are holding us back?", "answer": "We assess what can be improved versus replaced, creating a phased approach that maintains business continuity while modernizing."}]'
);
